...
intrpldf_batch4rb(t_adtf_dist_m_rnd1_full, colname4ref = "sxx_dist_m_rnd1", suffix = ".intrpl", outputFlag = T)
corrPosAnom_batch4rb(t_adtf_dist_m_rnd1_full.intrpl)
cut2dist_batch4rb(t_adtf_dist_m_rnd1_full.intrpl, "sxx_dist_m_rnd1", set4query$dist1 - 5, set4query$dist2)

t_adtf_dist_m_rnd1_full.intrpl.cut <- 
  addVar4PrecVeh(t_adtf_dist_m_rnd1_full.intrpl.cut)

t_adtf_dist_m_rnd1_full.intrpl.cut <- 
  addVar4Stopping(t_adtf_dist_m_rnd1_full.intrpl.cut)