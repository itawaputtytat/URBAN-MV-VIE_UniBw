...
intrpldf_batch4rb(adtf_sxx_dist_s_rnd1_rb, suffix = ".intrpl", outputFlag = T)
corrPosAnom_batch4rb(adtf_sxx_dist_s_rnd1_rb)
cut2dist_batch4rb(adtf_sxx_dist_s_rnd1_rb.intrpl, "sxx_dist_m_rnd1", set4query$dist1, set4query$dist2)
