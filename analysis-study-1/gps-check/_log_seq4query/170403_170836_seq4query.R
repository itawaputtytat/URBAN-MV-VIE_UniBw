...
map <- getMapImage(set4query$sxx, zoom = 17)

dat2vis <- t_adtf_dist_m_rnd1_full 
dat2vis <- t_adtf_dist_m_rnd1_full %>% filter_(paste0(sprintf("s%02s", set4query$sxx), "_dist_m_rnd1 ==", 0))
