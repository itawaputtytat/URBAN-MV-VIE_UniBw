...
windows(); plot(plot_pedal_acc_t1)
...
windows(); plot(plot_pedal_brake_1st)
...
test <- dat_pedal_measures$dat_acc_t1
...
plot_pedal_acc_t1_v50_post <- 
  plot_pedal_acc_t1_v50 + 
  ggtitle(label = "Lösen des Fahrpedals vor Linksabbiegen",
...
#windows(); plot(plot_pedal_acc_t1_v50_post)

sett$plot$file_name <- "pedal_act_p03_v50_acc"
...
plot_pedal_acc_t1_v70 <- 
  plotPedActSeq(dat_pedal_measures$dat_reduced_acc_t1 %>% 
...
sett$plot$file_name <- "pedal_act_p03_v70_acc"
