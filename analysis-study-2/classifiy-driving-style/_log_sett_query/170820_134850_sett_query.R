...
sapply(t_adtf_full_rnd1_full$brakepress_status, function(x) { all(x %in% 0:1) })
...
intrpldf_batch4rb(t_adtf_full_pxx_dist_s_rnd1, colname4ref = sett_query$var_dist, suffix = "intrpld", outputFlag = T)
cut2dist_batch4rb(t_adtf_full_rnd1_full.intrpl , "pxx_dist_m_rnd1", sett_query$dist1, sett_query$dist2)
correctAccPedalPos("t_adtf_full_rnd1_full")
