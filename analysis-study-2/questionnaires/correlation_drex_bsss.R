...
dat_all <- left_join(dat_drex, dat_bsss)
...
dat_plot[row_finder, "subscale_name"] <- "BSSS gesamt"
...
plot_corr_post <- 
  ...
  ggtitle("Korrelation von Fahrerfahrung und BSSS",
          subtitle = temp) + 
  labs(x = NULL,
       y = "Korrelation") + 
  theme_thesis()
