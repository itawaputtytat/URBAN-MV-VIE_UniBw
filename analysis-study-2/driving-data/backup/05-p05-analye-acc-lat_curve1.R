...
sett$db$src_names$dat <- "t_adtf_results_p05_dti_m_rnd1_acc_lat_max_aggr"
...
## Plot
sett$plot$file_name_prefix <- paste_(sprintf("p%02d", 5))
...
plot_acc_lat_max_aggr_post <- 
  ...
  ggtitle(label = "Maximale laterale Beschleunigung in Kurve 1",
