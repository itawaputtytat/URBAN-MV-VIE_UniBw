...
sett$db$src_names$dat <- "t_adtf_results_p01_dti_m_rnd1_acc_lon_max_aggr"
...
sett$col_names$condition_ds_sc <- "ds_sc"
...
## Plot
sett$plot$file_name_prefix <- paste_(sprintf("p%02d", 1))
...
plot_acc_lon_max_aggr_post <- 
  ...
  ggtitle(label = "Maximale longitudinale Beschleunigung beim Anfahren",
