...
sett$db$src_names$dat_p02 <- "t_adtf_results_p02_dti_m_rnd1_acc_lon_max_aggr"
sett$db$src_names$dat_p03 <- "t_adtf_results_p03_dti_m_rnd1_acc_lon_max_aggr"
...
plot_acc_lon_max_aggr_post <- 
  ...
  ggtitle(label = "Maximale longitudinale Beschleunigung nach dem Abbiegen",
