...
sett$db$src_names$dat_p05 <- "t_adtf_results_p05_dti_m_rnd1_acc_lat_max_aggr"
sett$db$src_names$dat_p06 <- "t_adtf_results_p06_dti_m_rnd1_acc_lat_max_aggr"
...
plot_acc_lat_max_aggr_post <- 
  ...
  ggtitle(label = "Maximale laterale Beschleunigung in Kurvenfahrten",
