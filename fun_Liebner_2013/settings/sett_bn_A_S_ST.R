...
predLiebner_initSettingsForBN_A_S_ST <- function(
  ...
  priors_speed,
  priors_acc_lon_max,
  priors_ind = rep(1 / length_ST, length_ST)) {
  ...
  ## State names
  sett_bn$state_names$ST <- state_names_ind
  ##
  ...
  sett_bn$state_names$A[["S"]] <- sett_bn$state_names$S$S
